...
import { GithubIcon, Twitter, ArrowUpRight, LinkedinIcon } from "lucide-react";

export default function Footer() {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="relative px-6 py-12 md:py-20 border-t border-border-muted bg-background overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex items-center md:justify-end">
            ...
            >
              ...
              <Link
                href="mailto:hakeembello983@gmail.com"
        ...
        <div className="pt-8 border-t border-border-muted flex flex-col md:flex-row justify-between gap-4">
          <p className="text-center text-[11px] capitalize tracking-widest text-content-muted font-bold">
            © {currentYear} Hackhim
          </p>
        </div>
      </div>
